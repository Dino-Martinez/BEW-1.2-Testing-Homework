...
class MainTests(unittest.TestCase):
    ...
    def test_book_detail_logged_out(self):
        ...
        self.assertIn('To Kill a Mockingbird', response_text)
        self.assertIn('Author: Harper Lee', response_text)
    ...
    def test_create_author(self):
        ...
        post_data = {
            'name': 'Johnny the Kid',
            'biography': 'This author does not exist lmao',
        }
        self.app.post('/create_author', data=post_data)

        # Make sure book was updated as we'd expect
        created_author = Author.query.filter_by(name='Johnny the Kid').one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.biography, 'This author does not exist lmao')
    ...
    def test_create_genre(self):
        ...
        # Make sure book was updated as we'd expect
        created_genre = Genre.query.filter_by(name='Choose Your Own Adventure').one()
    ...
    def test_favorite_book(self):
        """Test that a user can favorite a book."""
        # Set up
        create_books()
        create_user()
        login(self.app, 'me1', 'password')
        ...
        favorites_list = updated_user.favorite_books

        self.assertIn('To Kill a Mockingbird', str(favorites_list[0]))

    def test_unfavorite_book(self):
        """Test that a user can unfavorite a book."""
        # Set up
        create_books()
        create_user()
        login(self.app, 'me1', 'password')
